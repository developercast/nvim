...
-- vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/.dotfiles/nvim/.config/nvim/lua/developercasts/packer.lua<CR>");
...
-- Edit config
vim.keymap.set("n", "<Leader>ev", ":tabedit ~/.config/nvim/lua/developercasts/set.lua <CR>")
vim.keymap.set("n", "<Leader>ep", ":tabedit ~/.config/nvim/lua/developercasts/packer.lua <CR>")
vim.keymap.set("n", "<Leader>ek", ":tabedit ~/.config/nvim/lua/developercasts/remap.lua <CR>")
